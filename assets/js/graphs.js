$(function () {
    $('#ano').highcharts({
        ...
        series: [{
            ...
            data: [276,311,438,1044,1028,1637,2195,2540]
        }]
    });
});
    ...
    $('#ano3').highcharts({
       ...
       series: [{
            ...
            name: '2007',
            data: [17, 22, 74, 15, 14, 58, 110, 1, 0]
        }, {
            name: '2008',
            data: [0, 113, 130, 99, 0, 21, 55, 20, 0]
        }, {
            name: '2009',
            data: [98, 66, 149, 131, 40, 115, 244, 28, 0]
        }, {
            name: '2010',
            data: [139, 68, 150, 0, 35, 225, 162, 43, 204]
        }]
    });
});
